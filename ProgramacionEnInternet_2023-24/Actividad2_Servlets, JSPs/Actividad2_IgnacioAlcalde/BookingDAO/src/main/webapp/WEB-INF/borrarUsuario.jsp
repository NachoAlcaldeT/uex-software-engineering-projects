...
<body>
    ...
    <div class="container">
	    <div class="confirmation">
	        <h2>¿Estás seguro de que deseas eliminar tu usuario?</h2>
	        <p>Esta acción es irreversible y todos los datos asociados a tu usuario serán eliminados.</p>
	        <form action="BorrarUsuarioServlet.do" method="post" style="display: inline;">
	            <button class="btn" type="submit">Borrar Usuario</button>
	        </form>
