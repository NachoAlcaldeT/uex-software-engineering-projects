...
{    
    ...
    {        
        ...
        Equipo movistarWomen = new Equipo("Movistar Women", new HabilidadCiclistaComparador(), true, new PesoBicicletaComparador(), true);
        Equipo dSMWomen= new Equipo("DSM Women", new EnergiaCiclistaComparador(), true, new PesoBicicletaComparador(), true);
        Equipo trekSegafredoWomen = new Equipo("Trek Segafredo Women", new HabilidadCiclistaComparador(), false, new PesoBicicletaComparador(), false);
